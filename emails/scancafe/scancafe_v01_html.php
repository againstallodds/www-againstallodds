...
<head>
<title>Rescuing Your “Dead Pixels“ - my thoughts on ScanCafe</title>
</head>
<?php
$wd = 600;
$mg = 33;
...
echo ""
	...
	.'<div class="popup_box" style="position:relative; height:auto; left:0px; top:0px; background-color:transparent; border:none; visibility:hidden; z-index:0; padding:none; text-align:left;width:'.($wd+2*$mg).'px;left:0px;top:0px;visibility:visible;margin-left:auto;margin-right:auto;">'
		...
		ob_start(); require_once("scancafe_v01_text.txt"); $txt = ob_get_contents(); ob_end_clean();
		echo ''.
			str_replace("“","“<i>",
			...
			str_replace("”","”</i>",
			str_replace("http://www.scancafe.com/endorsed-by-pro-photographers   ","<a href=\"http://www.scancafe.com/endorsed-by-pro-photographers   \">http://www.scancafe.com/endorsed-by-pro-photographers   </a>",
			str_replace("http://www.scancafe.com/faq","<a href=\"http://www.scancafe.com/faq\">http://www.scancafe.com/faq</a>",
			str_replace("http://bit.ly/Scancafe","<a href=\"http://bit.ly/Scancafe\">http://bit.ly/Scancafe</a>",
			str_replace("http://terrywhite.com/techblog/archives/2791","<a href=\"http://terrywhite.com/techblog/archives/2791\">http://terrywhite.com/techblog/archives/2791</a>",
			str_replace("_Img1_","<img src=\"http://www.againstallodds.com/emails/scancafe/img/logo.gif\" style=\"position:relative;float:right;border:none;\"/>",
			str_replace("•<br /><br />","</li><br />",
			str_replace("• ","<li>",
			str_replace("\n\n","<br /><br />",$txt)
			)
			)
