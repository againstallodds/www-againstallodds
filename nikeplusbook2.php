...
*/		
	...
	//	{
			...
			ImageCopyResampled(	$inter_img
									, ImageCreateFromJPEG("nike/inc/2222222.orig_0.jpg")
								, 0, 0, 0,0
								, $mini_cover_wd, $mini_cover_ht, 832, 1024
								);		
			...
			ImageCopyResampled( $final_img, ImageRotate($inter_img,7,$red[0])
							, 25, 6, 0, 0
							, 200, 231, round($mini_cover_wd*$rot_rat['x']), round($mini_cover_ht*$rot_rat['y'])
							);
...
//require_once("nike_inc/stats.inc.php"); stat_rec("img_email",$_SERVER['REMOTE_ADDR']);
