...
function popup(action,ident,wh)
{
	...
	{	
		...
		{	
			...
			document.getElementById('popup_img_'+wh+'_'+ident).src = '/img/dynamic/work.'+document.getElementById('val_usr_'+ident).value+'.'+document.getElementById('val_wh_'+ident).value+'.jpg';
